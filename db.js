...
const DB = {
    ...
    // --- Initialization ---
    async initialize() {
        if (!GOOGLE_SCRIPT_URL || GOOGLE_SCRIPT_URL.includes("https://script.google.com/macros/s/AKfycbz-6c9HsOsiQGkM7y5mw8XRhnCDKltpl7RqHHUM1BgUTwNfYfRPFu4t7bm1epbG5D3HCg/exec")) {
